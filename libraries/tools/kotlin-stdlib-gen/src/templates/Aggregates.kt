...
fun aggregates(): List<GenericFunction> {
    ...
    templates add f("foldIndexed(initial: R, operation: (Int, R, T) -> R)") {
        ...
        doc { f ->
            ...
            @param operation function takes the index of ${f.element.prefixWithArticle()}, current accumulator value
    ...
    templates add f("foldRightIndexed(initial: R, operation: (Int, T, R) -> R)") {
        ...
        doc { f ->
            ...
            @param operation function takes the index of ${f.element.prefixWithArticle()}, the ${f.element} itself
    ...
    templates add f("forEachIndexed(action: (Int, T) -> Unit)") {
        ...
        doc { f ->
            ...
            @param action function takes the index of ${f.element.prefixWithArticle()} and the ${f.element} itself
